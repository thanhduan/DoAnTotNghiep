...
// Training Officer: users.read, rooms (read/update only), schedules.*, bookings.*, lockers.read, incidents (read/update/resolve), notifications (create/read), access_logs.read
const trainingOfficerPermissions = allPermissions
  .filter(p => [
    "users.read",
    "rooms.read", "rooms.update",  // Training Officer can only view and update rooms, not create/delete
